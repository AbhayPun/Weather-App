...
//             <AutocompleteComponent onDataChange={handleDataChange} type={`weather`} />
      ...
      <>
        ...
        <div className='flex flex-col lg:flex-row p-4 lg:space-x-6'>
          <div className='lg:w-1/2 bg-white shadow-lg rounded-lg overflow-hidden'>
            <header className='text-center bg-gradient-to-r from-yellow-500 to-teal-400 text-white py-4 mb-2'>
